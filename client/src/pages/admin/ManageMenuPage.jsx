        ...
        <form onSubmit={handleAddItem} className="grid md:grid-cols-4 gap-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/20 border border-white/10 rounded-xl py-3 pl-10 pr-4 outline-none focus:border-indigo-500 transition-all"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full bg-black/20 border border-white/10 rounded-xl py-3 px-4 outline-none focus:border-indigo-500 transition-all appearance-none cursor-pointer"
            >
          ...
          <button
            className="md:col-span-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-indigo-600/20 active:scale-95"
          >
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {menu
          ...
          .map((item) => (
            <div
              key={item._id}
              className="group bg-white/[0.02] border border-white/5 p-4 rounded-3xl hover:bg-white/[0.05] transition-all"
            >
              <div className="relative h-44 rounded-2xl overflow-hidden mb-4">
                ...
                />
                <span className="absolute top-3 left-3 bg-black/60 backdrop-blur-md text-[10px] uppercase font-bold px-3 py-1 rounded-full">
                  {item.category}
                </span>
              </div>
              ...
              <button
                ...
                className="w-full bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white py-2.5 rounded-xl transition-all flex items-center justify-center gap-2 text-sm font-semibold border border-red-500/20"
              >
